    ...
    <div className="relative mb-8">
      <div className="md:px-10 pt-4 pb-5 md:py-11 flex flex-col items-center text-center">
        ...
        <form
          ...
          className="mt-5 md:mt-6 w-full max-w-2xl flex flex-col gap-2 rounded-2xl md:rounded-3xl p-4 md:p-5 bg-white/[0.08] border border-white/[0.08] backdrop-blur-3xl backdrop-saturate-200"
        >
          <textarea
            ref={textareaRef}
            value={prompt}
