...
export function ReferralModal({ open, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-6">
      ...
      <div className="relative bg-[#181B22] border border-white/[0.10] rounded-2xl w-full max-w-[420px] p-6 shadow-2xl overflow-hidden">
        {/* 테두리 빛 효과 — ComingSoonModal과 동일 */}
        <BeamBorder className="rounded-2xl" durationMs={8000} opacity={0.5} />

        {/* 닫기 — LoginModal·ComingSoonModal과 동일 패턴 */}
        <button
          onClick={onClose}
          aria-label="닫기"
        ...
        <div className="mb-5 pr-8">
          ...
          <p className="text-sm text-zinc-400 mt-1">친구가 가입하면 둘 다 보너스 10크레딧 받아요</p>
        </div>
