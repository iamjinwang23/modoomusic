  ...
  return (
    <article className="space-y-8 text-zinc-300 leading-relaxed">
      <header className="space-y-2">
        ...
        <p className="text-sm text-zinc-500">시행일: 2026년 5월 27일 · 개정: 2026년 6월 24일 (유료서비스 가격·정책 변경, 부분 환불 산정 및 회사 귀책 환불 조항 추가) · 개정: 2026년 7월 1일 (커뮤니티 운영 조항 신설, 서비스 내 신고 기능 반영) · 개정: 2026년 7월 15일 (모바일 앱 출시에 따른 인앱결제·환불·플랫폼별 가격 조항 신설) · 개정: 2026년 7월 20일 (사용자 차단 기능 및 신고 24시간 처리·무관용 원칙 조항 반영)</p>
      </header>
      ...
      <Section title="제9조의2 (커뮤니티 운영)">
        <List items={[
          ...
          '커뮤니티 폐쇄 시 매니저 외 다른 회원이 작성한 게시글·댓글이 있는 경우, 폐쇄는 14일의 예고 기간을 거쳐 진행됩니다. 예고 기간 동안 해당 커뮤니티는 읽기 전용으로 전환되며, 회원은 그 기간 내에 본인이 작성한 콘텐츠를 내보내기(백업)할 수 있습니다. 다른 회원의 게시글·댓글이 없는 경우에는 즉시 폐쇄될 수 있습니다.',
          '폐쇄가 완료되면 해당 커뮤니티의 게시글·댓글·멤버십 등 관련 데이터는 삭제되며 복구되지 않습니다. 다만 회원이 첨부한 곡 등 개별 콘텐츠 자체는 삭제되지 않을 수 있습니다.',
      ...
      <Section title="제10조 (신고 및 이용 제한)">
        <List items={[
          '회사는 음란·폭력·차별·혐오·괴롭힘 등 부적절한 콘텐츠 및 학대 행위에 대해 무관용(zero tolerance) 원칙을 적용합니다.',
          '회원은 다른 회원의 게시물 또는 행위가 본 약관 또는 관련 법령을 위반한다고 판단되는 경우, 서비스 내 신고 기능 또는 고객센터 이메일(bee202408@gmail.com)을 통해 신고할 수 있습니다.',
          '회사는 신고를 접수하면 24시간 이내에 검토하여, 위반이 확인된 게시물은 삭제·비공개 처리하고 위반 회원에 대해 이용 제한 등 필요한 조치를 취합니다.',
          '회원은 다른 회원을 차단할 수 있으며, 차단 시 해당 회원의 콘텐츠는 회원의 화면에 즉시 노출되지 않습니다. 차단은 서비스 내 신고와 함께 이루어질 수 있습니다.',
      ...
      <Section id="payment" title="제12조 (유료서비스 결제, 정기구독 및 청약철회·환불)">
        <List items={[
          ...
          '(인앱결제) 모바일 앱(iOS·Android)에서의 유료서비스 결제는 각 앱마켓 사업자(Apple App Store, Google Play)가 제공하는 인앱결제(In-App Purchase) 시스템을 통해 처리됩니다. 이 경우 결제·청구는 해당 앱마켓 사업자를 통해 이루어지며, 회원의 결제수단 정보는 회사가 아닌 앱마켓 사업자가 관리합니다.',
          '(인앱결제 환불) 앱마켓 인앱결제로 구매한 상품의 환불은 회사가 직접 처리할 수 없으며, 해당 앱마켓 사업자(Apple·Google)의 환불 정책 및 절차에 따라 앱마켓 사업자에게 직접 요청해야 합니다. 다만 회사의 귀책사유·서비스 하자로 인한 환불 등 관련 법령이 정하는 경우에는 회사가 고객센터를 통해 환불을 지원합니다.',
          '(플랫폼별 가격 차이) 앱마켓 인앱결제에는 각 앱마켓 사업자의 수수료가 포함되므로, 동일하거나 유사한 상품이라도 웹과 앱, 또는 앱마켓에 따라 판매 가격이 다를 수 있습니다. 각 상품의 최종 가격은 결제 화면에 표시됩니다.',
        ]} />
      </Section>
      ...
      <Section title="제15조 (부칙)">
        <List items={[
          ...
          '제12조 (인앱결제), (인앱결제 환불), (플랫폼별 가격 차이) 조항은 2026년 7월 15일부터 시행됩니다.',
        ]} />
      </Section>
    </article>
  )
