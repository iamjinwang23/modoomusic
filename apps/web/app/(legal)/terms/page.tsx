  ...
  return (
    <article className="space-y-8 text-zinc-300 leading-relaxed">
      <header className="space-y-2">
        ...
        <p className="text-sm text-zinc-500">시행일: 2026년 5월 27일 · 개정: 2026년 6월 24일 (유료서비스 가격·정책 변경, 부분 환불 산정 및 회사 귀책 환불 조항 추가) · 개정: 2026년 7월 1일 (커뮤니티 운영 조항 신설, 서비스 내 신고 기능 반영) · 개정: 2026년 7월 15일 (모바일 앱 출시에 따른 인앱결제·환불·플랫폼별 가격 조항 신설)</p>
      </header>
