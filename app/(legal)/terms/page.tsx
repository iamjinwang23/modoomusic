  ...
  return (
    <article className="space-y-8 text-zinc-300 leading-relaxed">
      <header className="space-y-2">
        ...
        <p className="text-sm text-zinc-500">시행일: 2026년 5월 27일 · 개정: 2026년 6월 24일 (유료서비스 가격·정책 변경, 부분 환불 산정 및 회사 귀책 환불 조항 추가)</p>
      </header>
      ...
      <Section title="제10조 (신고 및 이용 제한)">
        <List items={[
          '회원은 다른 회원의 게시물 또는 행위가 본 약관 또는 관련 법령을 위반한다고 판단되는 경우, 고객센터 이메일(bee202408@gmail.com)을 통해 신고할 수 있습니다.',
